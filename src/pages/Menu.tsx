...
const Menu = () => {
  ...
  const specialItems = useMemo(() => {
    ...
    return menuItems.filter(item => item.isSpecial && item.active);
  }, [menuItems]);
              ...
              if (item.dietaryInfo[restriction]) {
                ...
                return (
                  <Tooltip key={restriction}>
                    ...
                    <TooltipContent>
                      <p>{restriction.replace(/([A-Z])/g, ' $1').trim()}</p>
                    </TooltipContent>
                  </Tooltip>
                );
              }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {specialItems.length > 0 && (
        <div className="mb-12">
          <h2 className="text-3xl font-serif font-bold text-bakery-brown mb-6">This Week's Specials</h2>
